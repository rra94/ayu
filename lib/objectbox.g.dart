...
final _entities = <obx_int.ModelEntity>[
  ...
  obx_int.ModelEntity(
    ...
    properties: <obx_int.ModelProperty>[
      ...
      obx_int.ModelProperty(
        id: const obx_int.IdUid(9, 3388427240463440883),
        name: 'scheduleDays',
        type: 9,
        flags: 0,
      ),
  ...
  final bindings = <Type, obx_int.EntityDefinition>{
    ...
    HabitOB: obx_int.EntityDefinition<HabitOB>(
      ...
      objectFromFB: (obx.Store store, ByteData fbData) {
        ...
        final scheduleDaysParam = const fb.StringReader(
          asciiOptimization: true,
        ).vTableGetNullable(buffer, rootOffset, 20);
        final monthlyDayParam = const fb.Int64Reader().vTableGetNullable(
          buffer,
          rootOffset,
          22,
        );
...
class HabitOB_ {
  ...
  /// See [HabitOB.scheduleDays].
  static final scheduleDays = obx.QueryStringProperty<HabitOB>(
