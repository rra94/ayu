...
class MicronutrientSummaryScreen extends StatelessWidget {
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          _buildNutrientRow(context, '  Leucine', totals['leucine'], null, 'g'),
          _buildNutrientRow(context, '  Isoleucine', totals['isoleucine'], null, 'g'),
          _buildNutrientRow(context, '  Valine', totals['valine'], null, 'g'),
          _buildNutrientRow(context, '  Lysine', totals['lysine'], null, 'g'),
          _buildNutrientRow(context, '  Methionine', totals['methionine'], null, 'g'),
          _buildNutrientRow(context, '  Phenylalanine', totals['phenylalanine'], null, 'g'),
          _buildNutrientRow(context, '  Threonine', totals['threonine'], null, 'g'),
          _buildNutrientRow(context, '  Tryptophan', totals['tryptophan'], null, 'g'),
          _buildNutrientRow(context, '  Histidine', totals['histidine'], null, 'g'),
  ...
  Map<String, double?> _computeDailyTotals(List<IntakeEntity> intakes) {
    ...
    final result = <String, double?>{
      ...
      'transFat': sum((i) => i.meal.nutriments.transFat100),
      'monoFat': sum((i) => i.meal.nutriments.monoFat100),
      'polyFat': sum((i) => i.meal.nutriments.polyFat100),
      'omega3': sum((i) => i.meal.nutriments.omega3100),
      ...
      'sugarAlcohols': sum((i) => i.meal.nutriments.sugarAlcohols100),
      // Amino acids
      'leucine': sum((i) => i.meal.nutriments.leucine100),
      'isoleucine': sum((i) => i.meal.nutriments.isoleucine100),
      'valine': sum((i) => i.meal.nutriments.valine100),
      'lysine': sum((i) => i.meal.nutriments.lysine100),
      'methionine': sum((i) => i.meal.nutriments.methionine100),
      'phenylalanine': sum((i) => i.meal.nutriments.phenylalanine100),
      'threonine': sum((i) => i.meal.nutriments.threonine100),
      'tryptophan': sum((i) => i.meal.nutriments.tryptophan100),
      'histidine': sum((i) => i.meal.nutriments.histidine100),
    };
