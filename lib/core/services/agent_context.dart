...
class AgentContext {
  ...
  /// Cached today's intakes — loaded once in AgentService, shared by all agents.
  List<IntakeEntity> todayIntakes = [];
  double get todayCalories =>
      todayIntakes.fold(0, (s, i) => s + i.totalKcal);
  double get todayProtein =>
      todayIntakes.fold(0, (s, i) => s + i.totalProteinsGram);
  double get todayFat =>
      todayIntakes.fold(0, (s, i) => s + i.totalFatsGram);
  double get todayCarbs =>
      todayIntakes.fold(0, (s, i) => s + i.totalCarbsGram);
